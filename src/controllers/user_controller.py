...
class UserController:
    ...
    def get_all_admins(self):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.SUCCESS, data=admin_data)
    ...
    def get_all_players(self):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.SUCCESS, data=player_data)
    ...
    def get_user_profile_data(self, user_id: str):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.SUCCESS, data=user_data[0])
    ...
    def create_admin(self, admin_data: Dict):
        ...
        return SuccessMessage(status=StatusCodes.CREATED, message=Message.ADMIN_CREATED)
    ...
    def update_user_data(self, user_id: str, user_data: Dict):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.PROFILE_UPDATED)
    ...
    def delete_admin_by_id(self, admin_id: str):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.ADMIN_DELETED)
    ...
    def delete_player_by_id(self, player_id: str):
        ...
        return SuccessMessage(status=StatusCodes.OK, message=Message.PLAYER_DELETED)
